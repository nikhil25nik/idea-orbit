...
export default function EditCategory() {
    ...
    const {data:categoryData,loading,error} = useFetch(`${getEnv("VITE_API_BASE_URL")}/api/category/show/${category_id}`,{
        method:"GET",
        credentials:"include"
    },[category_id])
  ...
  async function onSubmit(values) {
    try{
        const response = await fetch(`${getEnv("VITE_API_BASE_URL")}/api/category/update/${category_id}`,{
            method:"PUT",
